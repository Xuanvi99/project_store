function IconVerifyPw({ size }: { size: number }) {
  return (
    <svg aria-hidden="true" width={size} height={size} fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <defs>
        ...
        >
          <stop stopColor="#fd7e14" />
          <stop offset={1} stopColor="#F63" />
        </linearGradient>
      </defs>
    </svg>
  );
